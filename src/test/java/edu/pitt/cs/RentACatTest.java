...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		// By default r has no cats
		Cat returnVal = r.getCat(2);
		assertNull("Cat is not null", returnVal);
	}
	...
	public void testGetCatNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		Cat returnVal = r.getCat(2); // uses getID
		assertNotNull("Cat is null", returnVal);
		assertEquals("Cat does not have an ID of 2", 2, returnVal.getId());
	}
	...
	public void testCatAvailableFalseNumCats0() {
		boolean returnVal = r.catAvailable(2);
		assertFalse("Cat is available", returnVal);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		boolean returnVal = r.catAvailable(2); // Uses getRented, default is false -> cat is not rented
	...
	public void testCatExistsFalseNumCats0() {
		boolean returnVal = r.catExists(2);
		assertFalse(returnVal);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		boolean ret = r.catExists(2); // getID and getName already are stubbed in @Before annotation
		assertTrue(ret);
	}
